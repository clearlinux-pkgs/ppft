...
Source0  : https://github.com/uqfoundation/ppft/releases/download/ppft-1.7.6.7/ppft-1.7.6.7.tar.gz
...
%prep
%setup -q -n ppft-1.7.6.7
cd %{_builddir}/ppft-1.7.6.7
pushd ..
cp -a ppft-1.7.6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702061846
