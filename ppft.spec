...
Version  : 1.7.7
Release  : 17
URL      : https://github.com/uqfoundation/ppft/releases/download/1.7.7/ppft-1.7.7.tar.gz
Source0  : https://github.com/uqfoundation/ppft/releases/download/1.7.7/ppft-1.7.7.tar.gz
...
%prep
%setup -q -n ppft-1.7.7
cd %{_builddir}/ppft-1.7.7
pushd ..
cp -a ppft-1.7.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744813053
